...
namespace Plugin.BetterFirebasePushNotification
{
    ...
    public class FirebasePushNotificationManager : Java.Lang.Object, IFirebasePushNotification, IOnCompleteListener
    {
        ...
        internal const string KeyGroupName = "Plugin.BetterFirebasePushNotification";
            ...
            if (extras != null && !extras.IsEmpty)
            {
                ...
                if (parameters.Count > 0)
                {
                    ...
                    if (string.IsNullOrEmpty(response.Identifier))
                    {
                        ...
                        {
                            _onNotificationOpened?.Invoke(BetterFirebasePushNotification.Current, new FirebasePushNotificationResponseEventArgs(response.Data, response.Identifier, response.Type));
                        }
                    }
                    else
                    {
                    ...
                    BetterFirebasePushNotification.Current.NotificationHandler?.OnOpened(response);
                }

            }
        }
        public static void Initialize(bool resetToken, bool createDefaultNotificationChannel = true, bool autoRegistration = true)
        {
            ...
            if (autoRegistration)
            {
                ThreadPool.QueueUserWorkItem(state =>
                {
                    ...
                    var versionCode = AppInfo.Current.Version;
                    var versionName = AppInfo.Current.VersionString; 
                    ...
                    {
                        _onNotificationError?.Invoke(BetterFirebasePushNotification.Current, new FirebasePushNotificationErrorEventArgs(FirebasePushNotificationErrorType.UnregistrationFailed, ex.ToString()));
                    }
                    finally
                    {
                    ...
                    BetterFirebasePushNotification.Current.RegisterForPushNotifications();
            ...
            System.Diagnostics.Debug.WriteLine(BetterFirebasePushNotification.Current.Token);
        }
        public static void Initialize(NotificationUserCategory[] notificationCategories, bool resetToken, bool createDefaultNotificationChannel = true, bool autoRegistration = true)
        {

            Initialize(resetToken, createDefaultNotificationChannel, autoRegistration);
        ...
        public async Task<string> GetTokenAsync()
        {
            ...
            {
                _onNotificationError?.Invoke(BetterFirebasePushNotification.Current, new FirebasePushNotificationErrorEventArgs(FirebasePushNotificationErrorType.RegistrationFailed, $"{ex}"));
            }
        ...
        private static void CleanUp(bool clearAll = true)
        {
            if (clearAll)
            {
                BetterFirebasePushNotification.Current.UnsubscribeAll();
            }
        ...
        public static void Initialize(IPushNotificationHandler pushNotificationHandler, bool resetToken, bool createDefaultNotificationChannel = true, bool autoRegistration = true)
        {
            BetterFirebasePushNotification.Current.NotificationHandler = pushNotificationHandler;
            Initialize(resetToken, createDefaultNotificationChannel, autoRegistration);
        }
        ...
        public event FirebasePushNotificationResponseEventHandler OnNotificationOpened
        {
            add
            {
                ...
                if (delayedNotificationResponse != null && previousVal == null)
                {
                    ...
                    {
                        _onNotificationOpened?.Invoke(BetterFirebasePushNotification.Current, new FirebasePushNotificationResponseEventArgs(tmpParams.Data, tmpParams.Identifier, tmpParams.Type));
        ...
        public event FirebasePushNotificationResponseEventHandler OnNotificationAction
        {
            add
            {
                ...
                if (delayedNotificationResponse != null && previousVal == null)
                {
                    ...
                    if (!string.IsNullOrEmpty(tmpParams.Identifier))
                    {
                        _onNotificationAction?.Invoke(BetterFirebasePushNotification.Current, new FirebasePushNotificationResponseEventArgs(tmpParams.Data, tmpParams.Identifier, tmpParams.Type));
                        delayedNotificationResponse = null;
                    }
        ...
        {
            SaveToken(token);
            _onTokenRefresh?.Invoke(BetterFirebasePushNotification.Current, new FirebasePushNotificationTokenEventArgs(token));
        }
        internal static void RegisterData(IDictionary<string, object> data)
        {
            _onNotificationReceived?.Invoke(BetterFirebasePushNotification.Current, new FirebasePushNotificationDataEventArgs(data));
        }
        ...
        {
            _onNotificationDeleted?.Invoke(BetterFirebasePushNotification.Current, new FirebasePushNotificationDataEventArgs(data));
        }
